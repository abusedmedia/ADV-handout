...
d3.queue()
    .defer(d3.json, '../../datasets/geojson/countries.geo.json')
    .defer(d3.csv, '../../datasets/csv/populations.csv')
    .defer(d3.json, '../../datasets/topojson/world-atlas-50m.json')
    .defer(d3.csv, '../../datasets/geojson/worldcities.csv')
    .await(build)


function build(err, map, pop, topo, cities){
